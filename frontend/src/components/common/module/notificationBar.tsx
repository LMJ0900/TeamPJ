export default function NotificationBar () {
  ...
  <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow">
    <div className="container mx-auto px-4 py-2 flex justify-between items-center">
      <p className="text-sm text-gray-700">We use cookies to ensure you get the best experience on our website.
        Learn more <a href="https://larainfo.com/blogs/create-cookie-consent-design-ui-using-tailwind-css" className="text-blue-500">here</a>.</p>
