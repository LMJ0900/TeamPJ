            ...
            <div className=" relative mt-30">
                <div className="flex bg-white w-[50rem] h-[30rem] rounded-[10px] z-10 flex-row">
                    <div className="flex items-center flex-col w-[25rem] h-[30rem]">
                        ...
                        <button className="mt-[5rem] border-pink-400 text-pink-400 border-2 rounded-[20px] w-[7rem] h-[3rem]  font-semibold">login</button>
                    </div>
                    <div className="flex items-center flex-col w-[25rem] h-[30rem]">
                ...
                <div className={`flex items-center absolute top-[-5rem] left-[1rem] h-[40rem] w-[23rem] bg-[--color-pebble-1] rounded-[10px] flex-col z-0 ${isAnimating ? "animate-[TransRight_1.5s_ease-in-out_forwards]" : ""}`} id="LoginBack">
